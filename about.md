...
The three original authors use this textbook in the context of  "inverted" or "flipped" courses, often following an [inquiry-based model](https://www.flipcamp.org/engagingstudents/shafferpt3.html).
...
For more information about the inverted music class, see *Engaging Students: Essays in Music Pedagogy*, [Volume 1 (2013)](https://www.flipcamp.org/engagingstudents/index.html) and [Volume 2 (2014)](https://www.flipcamp.org/engagingstudents2/index.html).
...
This textbook is published by [Hybrid Pedagogy Publishing](https://www.hybridpedagogy.org/#publishing), under editors [Robin Wharton](https://www.robinwharton.com) and [Kris Shaffer](https://kris.shaffermusic.com).
...
For more information about HPP, [follow @HybridPub on Twitter](https://twitter.com/HybridPub).
...
We are also beyond grateful to have the financial and technological support from the team at [Trinket](https://www.trinket.io), who provided a matching donation in the amount of $2500, and who built the technology behind the interactive musical notation modules that appear in this text.
